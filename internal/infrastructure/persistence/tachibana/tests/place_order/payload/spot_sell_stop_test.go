...
// TestPlaceOrder_SpotSellStopPayload は現物売り逆指値注文(通常)のペイロードをテストします。
func TestPlaceOrder_SpotSellStopPayload(t *testing.T) {
	t.Run("正常系: 現物売り逆指値注文 (通常) のペイロードが正しく生成されること", func(t *testing.T) {
...
// go test -v ./internal/infrastructure/persistence/tachibana/tests/payload/place_order_spot_sell_stop_test.go
